...
namespace Microsoft.AspNet.SignalR.Redis
{
    ...
    public class RedisMessageBus : ScaleoutMessageBus
    {
        ...
        public RedisMessageBus(IDependencyResolver resolver, RedisScaleoutConfiguration configuration, IRedisConnection connection, TraceSource trace)
        ...
        private async void OnConnectionRestored(object sender, Exception ex)
        {
